...
class UnionMapperElement extends MapperElementBase<Union> {
  ...
  Union decode(dynamic v) => checkedType(v, (Map<String, dynamic> map) {
    switch(map['type']) {
      case 'data': return DataMapper().createElement(container).decode(map);
      case 'error': return ErrorDetailsMapper().createElement(container).decode(map);
      case 'loading': return LoadingMapper().createElement(container).decode(map);
...
class DataMapperElement extends MapperElementBase<Data> {
  ...
  Map<String, dynamic> toMap(Data d) => {'mykey': container.$enc(d.value, 'value'), 'type': 'data'};
...
class LoadingMapperElement extends MapperElementBase<Loading> {
  ...
  @override Function get decoder => decode;
  Loading decode(dynamic v) => checkedType(v, (Map<String, dynamic> map) => fromMap(map));
  Loading fromMap(Map<String, dynamic> map) => Loading(container.$get(map, 'value'));

  @override Function get encoder => encode;
  dynamic encode(Loading v) => toMap(v);
  Map<String, dynamic> toMap(Loading l) => {'value': container.$enc(l.value, 'value'), 'type': 'loading'};
...
class ErrorDetailsMapperElement extends MapperElementBase<ErrorDetails> {
  ...
  @override Function get decoder => decode;
  ErrorDetails decode(dynamic v) => checkedType(v, (Map<String, dynamic> map) => fromMap(map));
  ErrorDetails fromMap(Map<String, dynamic> map) => ErrorDetails(container.$get(map, 'value'), container.$getOpt(map, 'message'));

  @override Function get encoder => encode;
  dynamic encode(ErrorDetails v) => toMap(v);
  Map<String, dynamic> toMap(ErrorDetails e) => {'value': container.$enc(e.value, 'value'), 'message': container.$enc(e.message, 'message'), 'type': 'error'};
