...
class DogMapperElement extends MapperElementBase<Dog> {
  ...
  @override String stringify(Dog self) => 'Dog(name: ${container.asString(self.name)})';
}
...
class ZooMapperElement extends MapperElementBase<Zoo> {
  ...
  @override String stringify(Zoo self) => 'Zoo(animal: ${container.asString(self.animal)})';
}
...
class AMapper extends MapperBase<A> {
  ...
  @override Function get typeFactory => <T>(f) => f<A<T>>();
...
class AMapperElement extends MapperElementBase<A> {
  ...
  A<T> decode<T>(dynamic v) => checkedType(v, (Map<String, dynamic> map) => fromMap<T>(map));
...
class CMapper extends MapperBase<C> {
  ...
  @override Function get typeFactory => <T>(f) => f<C<T>>();
...
class CMapperElement extends MapperElementBase<C> {
  ...
  @override Function get decoder => decode;
  C<T> decode<T>(dynamic v) => checkedType(v, (Map<String, dynamic> map) => fromMap<T>(map));
...
class BMapperElement extends MapperElementBase<B> {
  ...
  B fromMap(Map<String, dynamic> map) => B(container.$get(map, 'list'), container.$getOpt(map, 'a'));

  @override Function get encoder => encode;
  dynamic encode(B v) => toMap(v);
  Map<String, dynamic> toMap(B b) => {'list': container.$enc(b.list, 'list'), 'a': container.$enc(b.a, 'a')};

  @override String stringify(B self) => 'B(list: ${container.asString(self.list)}, a: ${container.asString(self.a)})';
  @override int hash(B self) => container.hash(self.list) ^ container.hash(self.a);
  @override bool equals(B self, B other) => container.isEqual(self.list, other.list) && container.isEqual(self.a, other.a);
}
...
class _BCopyWithImpl<$R, $Out extends B> extends CopyWithBase<$R, B, $Out> implements BCopyWith<$R, B, $Out> {
  ...
  @override ListCopyWith<$R, A<dynamic>?, ACopyWith<$R, A<dynamic>, A<dynamic>, dynamic>?> get list => ListCopyWith($value.list, (v, t) => v?.copyWith.chain($identity, t), (v) => call(list: v));
