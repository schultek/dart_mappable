...
class ItemsMapperElement extends MapperElementBase<Items> {
  ...
  Items decode(dynamic v) => checkedType(v, (Map<String, dynamic> map) => fromMap(map));
  Items fromMap(Map<String, dynamic> map) => Items(container.$get(map, 'items'), container.$get(map, 'items2'));

  @override Function get encoder => encode;
  dynamic encode(Items v) => toMap(v);
  Map<String, dynamic> toMap(Items i) => {'items': container.$enc(i.items, 'items'), 'items2': container.$enc(i.items2, 'items2')};

  @override String stringify(Items self) => 'Items(items: ${container.asString(self.items)}, items2: ${container.asString(self.items2)})';
  @override int hash(Items self) => container.hash(self.items) ^ container.hash(self.items2);
  @override bool equals(Items self, Items other) => container.isEqual(self.items, other.items) && container.isEqual(self.items2, other.items2);
}
...
mixin ItemsMappable {
  ...
  @override String toString() => ItemsMapper.container.asString(this);
  @override bool operator ==(Object other) => identical(this, other) || (runtimeType == other.runtimeType && ItemsMapper.container.isEqual(this, other));
  @override int get hashCode => ItemsMapper.container.hash(this);
}
...
class _ItemsCopyWithImpl<$R, $Out extends Items> extends CopyWithBase<$R, Items, $Out> implements ItemsCopyWith<$R, Items, $Out> {
  ...
  @override ListCopyWith<$R, Item, ItemCopyWith<$R, Item, Item>> get items => ListCopyWith($value.items, (v, t) => v.copyWith.chain($identity, t), (v) => call(items: v));
  @override MapCopyWith<$R, int, Item, ItemCopyWith<$R, Item, Item>> get items2 => MapCopyWith($value.items2, (v, t) => v.copyWith.chain($identity, t), (v) => call(items2: v));
...
class ItemMapperElement extends MapperElementBase<Item> {
  ...
  @override Function get decoder => decode;
  Item decode(dynamic v) => checkedType(v, (Map<String, dynamic> map) => fromMap(map));
  Item fromMap(Map<String, dynamic> map) => Item(container.$get(map, 'index'));

  @override Function get encoder => encode;
  dynamic encode(Item v) => toMap(v);
  Map<String, dynamic> toMap(Item i) => {'index': container.$enc(i.index, 'index')};

  @override String stringify(Item self) => 'Item(index: ${container.asString(self.index)})';
  @override int hash(Item self) => container.hash(self.index);
  @override bool equals(Item self, Item other) => container.isEqual(self.index, other.index);
}
...
mixin ItemMappable {
  ...
  @override String toString() => ItemMapper.container.asString(this);
  @override bool operator ==(Object other) => identical(this, other) || (runtimeType == other.runtimeType && ItemMapper.container.isEqual(this, other));
  @override int get hashCode => ItemMapper.container.hash(this);
}
