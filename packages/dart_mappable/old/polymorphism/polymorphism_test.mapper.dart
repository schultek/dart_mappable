...
class AnimalMapperElement extends MapperElementBase<Animal> {
  ...
  Animal decode(dynamic v) => checkedType(v, (Map<String, dynamic> map) {
    switch(map['type']) {
      ...
      case null: return NullAnimalMapper().createElement(container).decode(map);
      default: return DefaultAnimalMapper().createElement(container).decode(map);
    }
  });
...
class DogMapperElement extends MapperElementBase<Dog> {
  ...
  Map<String, dynamic> toMap(Dog d) => {'age': container.$enc(d.age, 'age'), 'type': 1};

  @override String stringify(Dog self) => 'Dog(name: ${container.asString(self.name)}, age: ${container.asString(self.age)})';
  @override int hash(Dog self) => container.hash(self.name) ^ container.hash(self.age);
  @override bool equals(Dog self, Dog other) => container.isEqual(self.name, other.name) && container.isEqual(self.age, other.age);
}
...
class NullAnimalMapperElement extends MapperElementBase<NullAnimal> {
  ...
  @override Function get decoder => decode;
  NullAnimal decode(dynamic v) => checkedType(v, (Map<String, dynamic> map) => fromMap(map));
  NullAnimal fromMap(Map<String, dynamic> map) => NullAnimal(container.$get(map, 'name'));

  @override Function get encoder => encode;
  dynamic encode(NullAnimal v) => toMap(v);
  Map<String, dynamic> toMap(NullAnimal n) => {'name': container.$enc(n.name, 'name'), 'type': null};

  @override String stringify(NullAnimal self) => 'NullAnimal(name: ${container.asString(self.name)})';
  @override int hash(NullAnimal self) => container.hash(self.name);
  @override bool equals(NullAnimal self, NullAnimal other) => container.isEqual(self.name, other.name);
}

mixin NullAnimalMappable {
  String toJson() => NullAnimalMapper.container.toJson(this as NullAnimal);
  Map<String, dynamic> toMap() => NullAnimalMapper.container.toMap(this as NullAnimal);
  ...
  @override String toString() => NullAnimalMapper.container.asString(this);
  @override bool operator ==(Object other) => identical(this, other) || (runtimeType == other.runtimeType && NullAnimalMapper.container.isEqual(this, other));
  @override int get hashCode => NullAnimalMapper.container.hash(this);
}
...
class DefaultAnimalMapperElement extends MapperElementBase<DefaultAnimal> {
  ...
  @override Function get decoder => decode;
  DefaultAnimal decode(dynamic v) => checkedType(v, (Map<String, dynamic> map) => fromMap(map));
  DefaultAnimal fromMap(Map<String, dynamic> map) => DefaultAnimal(container.$get(map, 'name'), container.$get(map, 'type'));

  @override Function get encoder => encode;
  dynamic encode(DefaultAnimal v) => toMap(v);
  Map<String, dynamic> toMap(DefaultAnimal d) => {'name': container.$enc(d.name, 'name'), 'type': container.$enc(d.type, 'type')};

  @override String stringify(DefaultAnimal self) => 'DefaultAnimal(name: ${container.asString(self.name)}, type: ${container.asString(self.type)})';
  @override int hash(DefaultAnimal self) => container.hash(self.name) ^ container.hash(self.type);
  @override bool equals(DefaultAnimal self, DefaultAnimal other) => container.isEqual(self.name, other.name) && container.isEqual(self.type, other.type);
}

mixin DefaultAnimalMappable {
  String toJson() => DefaultAnimalMapper.container.toJson(this as DefaultAnimal);
  Map<String, dynamic> toMap() => DefaultAnimalMapper.container.toMap(this as DefaultAnimal);
  ...
  @override String toString() => DefaultAnimalMapper.container.asString(this);
  @override bool operator ==(Object other) => identical(this, other) || (runtimeType == other.runtimeType && DefaultAnimalMapper.container.isEqual(this, other));
  @override int get hashCode => DefaultAnimalMapper.container.hash(this);
}
...
class ZooMapperElement extends MapperElementBase<Zoo> {
  ...
  @override Function get decoder => decode;
  Zoo decode(dynamic v) => checkedType(v, (Map<String, dynamic> map) => fromMap(map));
  Zoo fromMap(Map<String, dynamic> map) => Zoo(container.$get(map, 'animal'), container.$get(map, 'animals'), container.$get(map, 'animals2'));

  @override Function get encoder => encode;
  dynamic encode(Zoo v) => toMap(v);
  Map<String, dynamic> toMap(Zoo z) => {'animal': container.$enc(z.animal, 'animal'), 'animals': container.$enc(z.animals, 'animals'), 'animals2': container.$enc(z.animals2, 'animals2')};

  @override String stringify(Zoo self) => 'Zoo(animal: ${container.asString(self.animal)}, animals: ${container.asString(self.animals)}, animals2: ${container.asString(self.animals2)})';
  @override int hash(Zoo self) => container.hash(self.animal) ^ container.hash(self.animals) ^ container.hash(self.animals2);
  @override bool equals(Zoo self, Zoo other) => container.isEqual(self.animal, other.animal) && container.isEqual(self.animals, other.animals) && container.isEqual(self.animals2, other.animals2);
}
...
class _ZooCopyWithImpl<$R, $Out extends Zoo> extends CopyWithBase<$R, Zoo, $Out> implements ZooCopyWith<$R, Zoo, $Out> {
  ...
  @override ListCopyWith<$R, Animal, AnimalCopyWith<$R, Animal, Animal>> get animals => ListCopyWith($value.animals, (v, t) => v.copyWith.chain($identity, t), (v) => call(animals: v));
  @override MapCopyWith<$R, String, Animal, AnimalCopyWith<$R, Animal, Animal>> get animals2 => MapCopyWith($value.animals2, (v, t) => v.copyWith.chain($identity, t), (v) => call(animals2: v));
