...
class GameMapper extends MapperBase<Game> {
  static MapperContainer container = MapperContainer(
    mappers: {GameMapper()},
    link: {
      CardGameMapper.container,
      PlayerMapper.container,
    },
  );
...
class GameMapperElement extends MapperElementBase<Game> {
  ...
  Game decode(dynamic v) => const GameHooks().decode(v, (v) => checkedType(v, (Map<String, dynamic> map) => fromMap(map)));
  Game fromMap(Map<String, dynamic> map) => Game(container.$get(map, 'player', const ChainedHooks([PlayerHooks(), UnmappedPropertiesHooks('unmapped_props')])));

  @override Function get encoder => encode;
  dynamic encode(Game v) => const GameHooks().encode<Game>(v, (v) => toMap(v));
  Map<String, dynamic> toMap(Game g) => {'player': container.$enc(g.player, 'player', const ChainedHooks([PlayerHooks(), UnmappedPropertiesHooks('unmapped_props')]))};

  @override String stringify(Game self) => 'Game(player: ${container.asString(self.player)})';
  @override int hash(Game self) => container.hash(self.player);
  @override bool equals(Game self, Game other) => container.isEqual(self.player, other.player);
}
...
mixin GameMappable {
  ...
  @override String toString() => GameMapper.container.asString(this);
  @override bool operator ==(Object other) => identical(this, other) || (runtimeType == other.runtimeType && GameMapper.container.isEqual(this, other));
  @override int get hashCode => GameMapper.container.hash(this);
}
...
class CardGameMapperElement extends MapperElementBase<CardGame> {
  ...
  CardGame decode(dynamic v) => checkedType(v, (Map<String, dynamic> map) => fromMap(map));
  CardGame fromMap(Map<String, dynamic> map) => CardGame(container.$get(map, 'player', const ChainedHooks([PlayerHooks(), UnmappedPropertiesHooks('unmapped_props'), CardPlayerHooks()])));

  @override Function get encoder => (CardGame v) => const GameHooks().encode<CardGame>(v, (v) => encode);
  dynamic encode(CardGame v) => toMap(v);
  Map<String, dynamic> toMap(CardGame c) => {'player': container.$enc(c.player, 'player', const ChainedHooks([PlayerHooks(), UnmappedPropertiesHooks('unmapped_props'), CardPlayerHooks()]))};

  @override String stringify(CardGame self) => 'CardGame(player: ${container.asString(self.player)})';
  @override int hash(CardGame self) => container.hash(self.player);
  @override bool equals(CardGame self, CardGame other) => container.isEqual(self.player, other.player);
}

mixin CardGameMappable {
  String toJson() => CardGameMapper.container.toJson(this as CardGame);
  Map<String, dynamic> toMap() => CardGameMapper.container.toMap(this as CardGame);
  CardGameCopyWith<CardGame, CardGame, CardGame> get copyWith => _CardGameCopyWithImpl(this as CardGame, $identity, $identity);
  @override String toString() => CardGameMapper.container.asString(this);
  @override bool operator ==(Object other) => identical(this, other) || (runtimeType == other.runtimeType && CardGameMapper.container.isEqual(this, other));
  @override int get hashCode => CardGameMapper.container.hash(this);
}
...
class PlayerMapperElement extends MapperElementBase<Player> {
  ...
  @override Function get decoder => decode;
  Player decode(dynamic v) => checkedType(v, (Map<String, dynamic> map) => fromMap(map));
  ...
  @override String stringify(Player self) => 'Player(id: ${container.asString(self.id)})';
  @override int hash(Player self) => container.hash(self.id);
  @override bool equals(Player self, Player other) => container.isEqual(self.id, other.id);
}
...
mixin PlayerMappable {
  ...
  @override String toString() => PlayerMapper.container.asString(this);
  @override bool operator ==(Object other) => identical(this, other) || (runtimeType == other.runtimeType && PlayerMapper.container.isEqual(this, other));
  @override int get hashCode => PlayerMapper.container.hash(this);
}
...
class ClothesMapperElement extends MapperElementBase<Clothes> {
  ...
  @override Function get decoder => decode;
  Clothes decode(dynamic v) => const UnmappedPropertiesHooks('unmapped_props').decode(v, (v) => checkedType(v, (Map<String, dynamic> map) => fromMap(map)));
  Clothes fromMap(Map<String, dynamic> map) => Clothes(container.$get(map, 'size'), unmappedProps: container.$getOpt(map, 'unmappedProps') ?? const {});

  @override Function get encoder => encode;
  dynamic encode(Clothes v) => const UnmappedPropertiesHooks('unmapped_props').encode<Clothes>(v, (v) => toMap(v));
  Map<String, dynamic> toMap(Clothes c) => {'size': container.$enc(c.size, 'size'), 'unmappedProps': container.$enc(c.unmappedProps, 'unmappedProps')};

  @override String stringify(Clothes self) => 'Clothes(size: ${container.asString(self.size)}, unmappedProps: ${container.asString(self.unmappedProps)})';
  @override int hash(Clothes self) => container.hash(self.size) ^ container.hash(self.unmappedProps);
  @override bool equals(Clothes self, Clothes other) => container.isEqual(self.size, other.size) && container.isEqual(self.unmappedProps, other.unmappedProps);
}

mixin ClothesMappable {
  String toJson() => ClothesMapper.container.toJson(this as Clothes);
  Map<String, dynamic> toMap() => ClothesMapper.container.toMap(this as Clothes);
  ClothesCopyWith<Clothes, Clothes, Clothes> get copyWith => _ClothesCopyWithImpl(this as Clothes, $identity, $identity);
  @override String toString() => ClothesMapper.container.asString(this);
  @override bool operator ==(Object other) => identical(this, other) || (runtimeType == other.runtimeType && ClothesMapper.container.isEqual(this, other));
  @override int get hashCode => ClothesMapper.container.hash(this);
}
...
class ComponentMapperElement extends MapperElementBase<Component> {
  ...
  @override Function get decoder => decode;
  Component decode(dynamic v) => const UnmappedPropertiesHooks('unmapped_props').decode(v, (v) => checkedType(v, (Map<String, dynamic> map) => fromMap(map)));
  Component fromMap(Map<String, dynamic> map) => Component(container.$get(map, 'id'), container.$getOpt(map, 'unmappedProps'), container.$get(map, 'name'));

  @override Function get encoder => encode;
  dynamic encode(Component v) => const UnmappedPropertiesHooks('unmapped_props').encode<Component>(v, (v) => toMap(v));
  Map<String, dynamic> toMap(Component c) => {'id': container.$enc(c.id, 'id'), 'unmappedProps': container.$enc(c.unmappedProps, 'unmappedProps'), 'name': container.$enc(c.name, 'name')};

  @override String stringify(Component self) => 'Component(id: ${container.asString(self.id)}, name: ${container.asString(self.name)}, unmappedProps: ${container.asString(self.unmappedProps)})';
  @override int hash(Component self) => container.hash(self.id) ^ container.hash(self.name) ^ container.hash(self.unmappedProps);
  @override bool equals(Component self, Component other) => container.isEqual(self.id, other.id) && container.isEqual(self.name, other.name) && container.isEqual(self.unmappedProps, other.unmappedProps);
}

mixin ComponentMappable {
  String toJson() => ComponentMapper.container.toJson(this as Component);
  Map<String, dynamic> toMap() => ComponentMapper.container.toMap(this as Component);
  ComponentCopyWith<Component, Component, Component> get copyWith => _ComponentCopyWithImpl(this as Component, $identity, $identity);
  @override String toString() => ComponentMapper.container.asString(this);
  @override bool operator ==(Object other) => identical(this, other) || (runtimeType == other.runtimeType && ComponentMapper.container.isEqual(this, other));
  @override int get hashCode => ComponentMapper.container.hash(this);
}
