...
extension CakeMapperExtension on f.Cake {
  ...
  CakeCopyWith<f.Cake, f.Cake, f.Cake> get copyWith => _CakeCopyWithImpl(this, $identity, $identity);
}

extension CakeValueCopy<$R, $Out extends f.Cake> on ObjectCopyWith<$R, f.Cake, $Out> {
  CakeCopyWith<$R, f.Cake, $Out> get asCake => base.as((v, t, t2) => _CakeCopyWithImpl(v, t, t2));
}

typedef CakeCopyWithBound = f.Cake;
abstract class CakeCopyWith<$R, $In extends f.Cake, $Out extends f.Cake> implements ObjectCopyWith<$R, $In, $Out> {
  CakeCopyWith<$R2, $In, $Out2> chain<$R2, $Out2 extends f.Cake>(Then<f.Cake, $Out2> t, Then<$Out2, $R2> t2);
  $R call({String? type});
}

class _CakeCopyWithImpl<$R, $Out extends f.Cake> extends CopyWithBase<$R, f.Cake, $Out> implements CakeCopyWith<$R, f.Cake, $Out> {
  _CakeCopyWithImpl(super.value, super.then, super.then2);
  @override CakeCopyWith<$R2, f.Cake, $Out2> chain<$R2, $Out2 extends f.Cake>(Then<f.Cake, $Out2> t, Then<$Out2, $R2> t2) => _CakeCopyWithImpl($value, t, t2);

  @override $R call({String? type}) => $then(f.Cake(type ?? $value.type));
}
...
extension Person2MapperExtension on m.Person {
  ...
  Person2CopyWith<m.Person, m.Person, m.Person> get copyWith => _Person2CopyWithImpl(this, $identity, $identity);
}

extension Person2ValueCopy<$R, $Out extends m.Person> on ObjectCopyWith<$R, m.Person, $Out> {
  Person2CopyWith<$R, m.Person, $Out> get asPerson => base.as((v, t, t2) => _Person2CopyWithImpl(v, t, t2));
}

typedef Person2CopyWithBound = m.Person;
abstract class Person2CopyWith<$R, $In extends m.Person, $Out extends m.Person> implements ObjectCopyWith<$R, $In, $Out> {
  Person2CopyWith<$R2, $In, $Out2> chain<$R2, $Out2 extends m.Person>(Then<m.Person, $Out2> t, Then<$Out2, $R2> t2);
  $R call({String? firstName});
}

class _Person2CopyWithImpl<$R, $Out extends m.Person> extends CopyWithBase<$R, m.Person, $Out> implements Person2CopyWith<$R, m.Person, $Out> {
  _Person2CopyWithImpl(super.value, super.then, super.then2);
  @override Person2CopyWith<$R2, m.Person, $Out2> chain<$R2, $Out2 extends m.Person>(Then<m.Person, $Out2> t, Then<$Out2, $R2> t2) => _Person2CopyWithImpl($value, t, t2);

  @override $R call({String? firstName}) => $then(m.Person(firstName ?? $value.firstName));
}
...
abstract class AnimalCopyWith<$R, $In extends o.Animal, $Out extends o.Animal> implements ObjectCopyWith<$R, $In, $Out> {
  AnimalCopyWith<$R2, $In, $Out2> chain<$R2, $Out2 extends o.Animal>(Then<o.Animal, $Out2> t, Then<$Out2, $R2> t2);
  $R call({String? color});
}
...
extension PetMapperExtension on o.Pet {
  ...
  PetCopyWith<o.Pet, o.Pet, o.Pet> get copyWith => _PetCopyWithImpl(this, $identity, $identity);
}

extension PetValueCopy<$R, $Out extends o.Animal> on ObjectCopyWith<$R, o.Pet, $Out> {
  PetCopyWith<$R, o.Pet, $Out> get asPet => base.as((v, t, t2) => _PetCopyWithImpl(v, t, t2));
}

typedef PetCopyWithBound = o.Animal;
abstract class PetCopyWith<$R, $In extends o.Pet, $Out extends o.Animal> implements AnimalCopyWith<$R, $In, $Out> {
  PetCopyWith<$R2, $In, $Out2> chain<$R2, $Out2 extends o.Animal>(Then<o.Pet, $Out2> t, Then<$Out2, $R2> t2);
  Person2CopyWith<$R, m.Person, m.Person> get owner;
  @override $R call({m.Person? owner, String? color});
}

class _PetCopyWithImpl<$R, $Out extends o.Animal> extends CopyWithBase<$R, o.Pet, $Out> implements PetCopyWith<$R, o.Pet, $Out> {
  _PetCopyWithImpl(super.value, super.then, super.then2);
  @override PetCopyWith<$R2, o.Pet, $Out2> chain<$R2, $Out2 extends o.Animal>(Then<o.Pet, $Out2> t, Then<$Out2, $R2> t2) => _PetCopyWithImpl($value, t, t2);

  @override Person2CopyWith<$R, m.Person, m.Person> get owner => $value.owner.copyWith.chain($identity, (v) => call(owner: v));
  @override $R call({m.Person? owner, String? color}) => $then(o.Pet(owner ?? $value.owner, color ?? $value.color));
}
