...
class BoxMapper extends ClassMapperBase<Box> {
  ...
  final Map<Symbol, Field<Box, dynamic>> fields = const {
    ...
    #contents: Field<Box, List<Content>>('contents', _$contents, arg: _arg$contents),
  };
...
class _BoxCopyWithImpl<$R, $Out extends Box, T extends Content> extends CopyWithBase<$R, Box<T>, $Out> implements BoxCopyWith<$R, Box<T>, $Out, T> {
  ...
  @override ListCopyWith<$R, T, ContentCopyWith<$R, T, T>> get contents => ListCopyWith($value.contents, (v, t) => $cast(v.copyWith.chain<$R, T>($cast, t)), (v) => call(contents: v));
...
class SingleSettingMapper extends ClassMapperBase<SingleSetting> {
  ...
  final Map<Symbol, Field<SingleSetting, dynamic>> fields = const {
    #properties: Field<SingleSetting, List<dynamic>?>('properties', _$properties, opt: true, arg: _arg$properties),
  };
...
class SettingsMapper extends ClassMapperBase<Settings> {
  ...
  static Map<String, SingleSetting<dynamic>>? _$settings(Settings v) => v.settings;

  @override
  final Map<Symbol, Field<Settings, dynamic>> fields = const {
    #settings: Field<Settings, Map<String, SingleSetting<dynamic>>?>('settings', _$settings, opt: true),
  };
...
class _SettingsCopyWithImpl<$R, $Out extends Settings> extends CopyWithBase<$R, Settings, $Out> implements SettingsCopyWith<$R, Settings, $Out> {
  ...
  @override MapCopyWith<$R, String, SingleSetting<dynamic>, SingleSettingCopyWith<$R, SingleSetting<dynamic>, SingleSetting<dynamic>, dynamic>>? get settings => $value.settings != null ? MapCopyWith($value.settings!, (v, t) => v.copyWith.chain<$R, SingleSetting<dynamic>>($identity, t), (v) => call(settings: v)) : null;
...
mixin AssetMappable<T> {
  ...
  AssetCopyWith<Asset<T>, Asset<T>, Asset<T>, T> get copyWith => _AssetCopyWithImpl(this as Asset<T>, $identity, $identity);
  @override
  String toString() {
    AssetMapper.ensureInitialized();
    return MapperContainer.globals.asString(this);
...
extension AssetValueCopy<$R, $Out extends Asset, T> on ObjectCopyWith<$R, Asset<T>, $Out> {
  AssetCopyWith<$R, Asset<T>, $Out, T> get asAsset => base.as((v, t, t2) => _AssetCopyWithImpl(v, t, t2));
}

typedef AssetCopyWithBound = Asset;
abstract class AssetCopyWith<$R, $In extends Asset<T>, $Out extends Asset, T> implements ObjectCopyWith<$R, $In, $Out> {
  AssetCopyWith<$R2, $In, $Out2, T> chain<$R2, $Out2 extends Asset>(Then<Asset<T>, $Out2> t, Then<$Out2, $R2> t2);
  $R call({T? data});
}

class _AssetCopyWithImpl<$R, $Out extends Asset, T> extends CopyWithBase<$R, Asset<T>, $Out> implements AssetCopyWith<$R, Asset<T>, $Out, T> {
  _AssetCopyWithImpl(super.value, super.then, super.then2);
  @override AssetCopyWith<$R2, Asset<T>, $Out2, T> chain<$R2, $Out2 extends Asset>(Then<Asset<T>, $Out2> t, Then<$Out2, $R2> t2) => _AssetCopyWithImpl($value, t, t2);

  @override $R call({T? data}) => $then(Asset(data: data ?? $value.data));
}
