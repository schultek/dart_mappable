...
class ExampleMapper extends ClassMapperBase<Example> {
  ...
  static const Field<Example, Function?> _f$functionField =
      Field('functionField', _$functionField, arg: _arg$functionField);
...
mixin ExampleMappable {
  ExampleCopyWith<Example, Example, Example> get copyWith =>
      _ExampleCopyWithImpl<Example, Example>(
          this as Example, $identity, $identity);
  @override
  String toString() {
  ...
  bool operator ==(Object other) {
    return ExampleMapper.ensureInitialized()
        .equalsValue(this as Example, other);
  }
...
class _ExampleCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({Object? functionField = $none}) => $apply(FieldCopyWithData(
