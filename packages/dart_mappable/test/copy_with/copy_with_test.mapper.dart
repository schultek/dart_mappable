...
class _DealershipCopyWithImpl<$R, $Out extends Dealership> extends CopyWithBase<$R, Dealership, $Out> implements DealershipCopyWith<$R, Dealership, $Out> {
  ...
  @override ListCopyWith<$R, Car, CarCopyWith<$R, Car, Car>> get cars => ListCopyWith($value.cars, (v, t) => v.copyWith.chain<$R, Car>($identity, t), (v) => call(cars: v));
  @override MapCopyWith<$R, Brand, Person?, PersonCopyWith<$R, Person, Person>?> get salesRep => MapCopyWith($value.salesRep, (v, t) => v?.copyWith.chain<$R, Person>($identity, t), (v) => call(salesRep: v));
...
class ItemListMapper extends ClassMapperBase<ItemList> {
  ...
  static ItemList<T> _instantiate<T>(DecodingData data) {
    throw MapperException.missingSubclass('ItemList', 'type', '${data.value['type']}');
  }
  @override
  final Function instantiate = _instantiate;
...
class _BrandListCopyWithImpl<$R, $Out extends ItemList> extends CopyWithBase<$R, BrandList, $Out> implements BrandListCopyWith<$R, BrandList, $Out> {
  ...
  @override ListCopyWith<$R, Brand?, BrandCopyWith<$R, Brand, Brand>?> get items => ListCopyWith($value.items, (v, t) => v?.copyWith.chain<$R, Brand>($identity, t), (v) => call(items: v));
  @override $R call({Object? items = $none}) => $then(BrandList(or(items, $value.items)));
}

class NamedItemListMapper extends DiscriminatorSubClassMapperBase<NamedItemList> {
  ...
  final Map<Symbol, Field<NamedItemList, dynamic>> fields = const {
    ...
    #items: Field<NamedItemList, List<dynamic>>('items', _$items, arg: _arg$items),
  };
...
class KeyedItemListMapper extends DiscriminatorSubClassMapperBase<KeyedItemList> {
  ...
  final Map<Symbol, Field<KeyedItemList, dynamic>> fields = const {
    ...
    #items: Field<KeyedItemList, List<dynamic>>('items', _$items, arg: _arg$items),
  };
...
class ComparableItemListMapper extends DiscriminatorSubClassMapperBase<ComparableItemList> {
  ...
  @override
  Function get typeFactory => <T extends Comparable<dynamic>>(f) => f<ComparableItemList<T>>();
  ...
  final Map<Symbol, Field<ComparableItemList, dynamic>> fields = const {
    #items: Field<ComparableItemList, List<Comparable<dynamic>>>('items', _$items, arg: _arg$items),
  };
  ...
  static ComparableItemList<T> _instantiate<T extends Comparable<dynamic>>(DecodingData data) {
    return ComparableItemList(data.get(#items));
  }
  @override
  final Function instantiate = _instantiate;

  static ComparableItemList<T> fromMap<T extends Comparable<dynamic>>(Map<String, dynamic> map) {
    ensureInitialized();
    return MapperContainer.globals.fromMap<ComparableItemList<T>>(map);
  }
  static ComparableItemList<T> fromJson<T extends Comparable<dynamic>>(String json) {
    ensureInitialized();
