...
class PersonMapperElement extends MapperElementBase<Person> {
  ...
  Person fromMap(Map<String, dynamic> map) =>
      Person(container.$get(map, 'name'), container.$get(map, 'car'));
  ...
  String stringify(Person self) =>
      'Person(name: ${container.asString(self.name)}, car: ${container.asString(self.car)})';
  @override
  int hash(Person self) => container.hash(self.name) ^ container.hash(self.car);
  @override
...
class CarMapperElement extends MapperElementBase<Car> {
  ...
  Car fromMap(Map<String, dynamic> map) =>
      Car(container.$getOpt(map, 'brand'), container.$get(map, 'model'));
  ...
  Map<String, dynamic> toMap(Car c) => {
        ...
        'model': container.$enc(c.model, 'model')
      };

  @override
  String stringify(Car self) =>
      'Car(model: ${container.asString(self.model)}, brand: ${container.asString(self.brand)})';
  @override
  int hash(Car self) => container.hash(self.model) ^ container.hash(self.brand);
  @override
...
class BrandMapperElement extends MapperElementBase<Brand> {
  ...
  @override
  Function get decoder => decode;
  Brand decode(dynamic v) =>
      checkedType(v, (Map<String, dynamic> map) => fromMap(map));
  Brand fromMap(Map<String, dynamic> map) =>
      Brand(container.$getOpt(map, 'name'));

  @override
  Function get encoder => encode;
  dynamic encode(Brand v) => toMap(v);
  Map<String, dynamic> toMap(Brand b) =>
      {'name': container.$enc(b.name, 'name')};

  @override
  String stringify(Brand self) =>
      'Brand(name: ${container.asString(self.name)})';
  @override
  int hash(Brand self) => container.hash(self.name);
  @override
  bool equals(Brand self, Brand other) =>
      container.isEqual(self.name, other.name);
}
...
mixin BrandMappable {
  ...
  @override
  String toString() => BrandMapper.container.asString(this);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (runtimeType == other.runtimeType &&
          BrandMapper.container.isEqual(this, other));
  @override
  int get hashCode => BrandMapper.container.hash(this);
}
...
class DealershipMapperElement extends MapperElementBase<Dealership> {
  ...
  @override
  Function get decoder => decode;
  Dealership decode(dynamic v) =>
      checkedType(v, (Map<String, dynamic> map) => fromMap(map));
  Dealership fromMap(Map<String, dynamic> map) =>
      Dealership(container.$get(map, 'cars'), container.$get(map, 'salesRep'));

  @override
  Function get encoder => encode;
  dynamic encode(Dealership v) => toMap(v);
  Map<String, dynamic> toMap(Dealership d) => {
        'cars': container.$enc(d.cars, 'cars'),
        'salesRep': container.$enc(d.salesRep, 'salesRep')
      };

  @override
  String stringify(Dealership self) =>
      'Dealership(cars: ${container.asString(self.cars)}, salesRep: ${container.asString(self.salesRep)})';
  @override
  int hash(Dealership self) =>
      container.hash(self.cars) ^ container.hash(self.salesRep);
  @override
  bool equals(Dealership self, Dealership other) =>
      container.isEqual(self.cars, other.cars) &&
      container.isEqual(self.salesRep, other.salesRep);
}

mixin DealershipMappable {
  String toJson() => DealershipMapper.container.toJson(this as Dealership);
  Map<String, dynamic> toMap() =>
      DealershipMapper.container.toMap(this as Dealership);
  ...
  @override
  String toString() => DealershipMapper.container.asString(this);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (runtimeType == other.runtimeType &&
          DealershipMapper.container.isEqual(this, other));
  @override
  int get hashCode => DealershipMapper.container.hash(this);
}
...
class ItemListMapper extends MapperBase<ItemList> {
  ...
  static ItemList<T> fromJson<T>(String json) =>
      container.fromJson<ItemList<T>>(json);
}
...
class ItemListMapperElement extends MapperElementBase<ItemList> {
  ...
  @override
  Function get decoder => decode;
  ItemList<T> decode<T>(dynamic v) =>
      checkedType(v, (Map<String, dynamic> map) {
        switch (map['type']) {
          case 'BrandList':
            return BrandListMapper().createElement(container).decode(map)
                as ItemList<T>;
          case 'ComparableItemList':
            return ComparableItemListMapper()
                .createElement(container)
                .decode(map) as ItemList<T>;
          case 'KeyedItemList':
            return KeyedItemListMapper().createElement(container).decode(map)
                as ItemList<T>;
          case 'NamedItemList':
            return NamedItemListMapper().createElement(container).decode(map)
                as ItemList<T>;
          default:
            return fromMap<T>(map);
        }
      });
  ItemList<T> fromMap<T>(Map<String, dynamic> map) =>
      throw MapperException.missingSubclass(
          'ItemList', 'type', '${map['type']}');
  ...
  String stringify(ItemList self) =>
      'ItemList(items: ${container.asString(self.items)})';
  @override
  int hash(ItemList self) => container.hash(self.items);
  @override
  bool equals(ItemList self, ItemList other) =>
...
class BrandListMapper extends MapperBase<BrandList> {
  ...
  static MapperContainer container = _c ??
      ((_c = MapperContainer(
        ...
        ..linkAll({ItemListMapper.container, BrandMapper.container}));
...
class BrandListMapperElement extends MapperElementBase<BrandList> {
  ...
  @override
  Function get decoder => decode;
  BrandList decode(dynamic v) =>
      checkedType(v, (Map<String, dynamic> map) => fromMap(map));
  BrandList fromMap(Map<String, dynamic> map) =>
      BrandList(container.$getOpt(map, 'brands'));

  @override
  Function get encoder => encode;
  dynamic encode(BrandList v) => toMap(v);
  Map<String, dynamic> toMap(BrandList b) =>
      {'brands': container.$enc(b.items, 'items'), 'type': 'BrandList'};

  @override
  String stringify(BrandList self) =>
      'BrandList(items: ${container.asString(self.items)})';
  @override
  int hash(BrandList self) => container.hash(self.items);
  @override
  bool equals(BrandList self, BrandList other) =>
      container.isEqual(self.items, other.items);
}
...
mixin BrandListMappable {
  ...
  Map<String, dynamic> toMap() =>
      BrandListMapper.container.toMap(this as BrandList);
  BrandListCopyWith<BrandList, BrandList, BrandList> get copyWith =>
      _BrandListCopyWithImpl(this as BrandList, $identity, $identity);
  @override
  String toString() => BrandListMapper.container.asString(this);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (runtimeType == other.runtimeType &&
          BrandListMapper.container.isEqual(this, other));
  @override
  int get hashCode => BrandListMapper.container.hash(this);
}
...
class NamedItemListMapper extends MapperBase<NamedItemList> {
  ...
  static MapperContainer container = _c ??
      ((_c = MapperContainer(
        ...
        ..linkAll({ItemListMapper.container}));
  ...
  static NamedItemList<T> fromJson<T>(String json) =>
      container.fromJson<NamedItemList<T>>(json);
}
...
class NamedItemListMapperElement extends MapperElementBase<NamedItemList> {
  ...
  @override
  Function get decoder => decode;
  NamedItemList<T> decode<T>(dynamic v) =>
      checkedType(v, (Map<String, dynamic> map) => fromMap<T>(map));
  NamedItemList<T> fromMap<T>(Map<String, dynamic> map) => NamedItemList(
      container.$get(map, 'name'), container.$getOpt(map, 'items'));
  ...
  @override
  String stringify(NamedItemList self) =>
      'NamedItemList(items: ${container.asString(self.items)}, name: ${container.asString(self.name)})';
  @override
  int hash(NamedItemList self) =>
      container.hash(self.items) ^ container.hash(self.name);
  @override
  bool equals(NamedItemList self, NamedItemList other) =>
      container.isEqual(self.items, other.items) &&
      container.isEqual(self.name, other.name);
}
...
mixin NamedItemListMappable<T> {
  String toJson() =>
      NamedItemListMapper.container.toJson(this as NamedItemList<T>);
  Map<String, dynamic> toMap() =>
      NamedItemListMapper.container.toMap(this as NamedItemList<T>);
  ...
  @override
  String toString() => NamedItemListMapper.container.asString(this);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (runtimeType == other.runtimeType &&
          NamedItemListMapper.container.isEqual(this, other));
  @override
  int get hashCode => NamedItemListMapper.container.hash(this);
}
...
class KeyedItemListMapper extends MapperBase<KeyedItemList> {
  ...
  static KeyedItemList<K, T> fromJson<K, T>(String json) =>
      container.fromJson<KeyedItemList<K, T>>(json);
}
...
class KeyedItemListMapperElement extends MapperElementBase<KeyedItemList> {
  ...
  @override
  Function get decoder => decode;
  KeyedItemList<K, T> decode<K, T>(dynamic v) =>
      checkedType(v, (Map<String, dynamic> map) => fromMap<K, T>(map));
  KeyedItemList<K, T> fromMap<K, T>(Map<String, dynamic> map) => KeyedItemList(
      container.$get(map, 'key'), container.$getOpt(map, 'items'));
  ...
  @override
  String stringify(KeyedItemList self) =>
      'KeyedItemList(items: ${container.asString(self.items)}, key: ${container.asString(self.key)})';
  @override
  int hash(KeyedItemList self) =>
      container.hash(self.items) ^ container.hash(self.key);
  @override
  bool equals(KeyedItemList self, KeyedItemList other) =>
      container.isEqual(self.items, other.items) &&
...
mixin KeyedItemListMappable<K, T> {
  String toJson() =>
      KeyedItemListMapper.container.toJson(this as KeyedItemList<K, T>);
  Map<String, dynamic> toMap() =>
      KeyedItemListMapper.container.toMap(this as KeyedItemList<K, T>);
  ...
  @override
  String toString() => KeyedItemListMapper.container.asString(this);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (runtimeType == other.runtimeType &&
          KeyedItemListMapper.container.isEqual(this, other));
  @override
  int get hashCode => KeyedItemListMapper.container.hash(this);
}
...
class ComparableItemListMapper extends MapperBase<ComparableItemList> {
  ...
  static MapperContainer container = _c ??
      ((_c = MapperContainer(
        ...
        types: {'Comparable': (f) => f<Comparable>()},
      ))
        ..linkAll({ItemListMapper.container}));
  ...
  static ComparableItemList<T> fromJson<T extends Comparable<dynamic>>(
          String json) =>
      container.fromJson<ComparableItemList<T>>(json);
}

class ComparableItemListMapperElement
    extends MapperElementBase<ComparableItemList> {
  ComparableItemListMapperElement._(super.mapper, super.container);

  @override
  Function get decoder => decode;
  ComparableItemList<T> decode<T extends Comparable<dynamic>>(dynamic v) =>
      checkedType(v, (Map<String, dynamic> map) => fromMap<T>(map));
  ComparableItemList<T> fromMap<T extends Comparable<dynamic>>(
          Map<String, dynamic> map) =>
      ComparableItemList(container.$getOpt(map, 'items'));

  @override
  Function get encoder => encode;
  dynamic encode<T extends Comparable<dynamic>>(ComparableItemList<T> v) =>
      toMap<T>(v);
  ...
  String stringify(ComparableItemList self) =>
      'ComparableItemList(items: ${container.asString(self.items)})';
  @override
  int hash(ComparableItemList self) => container.hash(self.items);
  @override
  bool equals(ComparableItemList self, ComparableItemList other) =>
      container.isEqual(self.items, other.items);
}

mixin ComparableItemListMappable<T extends Comparable<dynamic>> {
  String toJson() =>
      ComparableItemListMapper.container.toJson(this as ComparableItemList<T>);
  Map<String, dynamic> toMap() =>
      ComparableItemListMapper.container.toMap(this as ComparableItemList<T>);
  ...
  @override
  String toString() => ComparableItemListMapper.container.asString(this);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (runtimeType == other.runtimeType &&
          ComparableItemListMapper.container.isEqual(this, other));
  @override
  int get hashCode => ComparableItemListMapper.container.hash(this);
}
