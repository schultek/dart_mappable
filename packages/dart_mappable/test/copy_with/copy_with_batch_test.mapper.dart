...
part of 'copy_with_batch_test.dart';
...
abstract class ACopyWith<$R, $In extends A, $Out extends A>
  ...
  ObjectCopyWith<$R, String?, String?> get a;
  BCopyWith<$R, B, B>? get b;
  $R call({String? a, B? b});
  $R $batch(void Function(ACopyWith<void, $In, $Out> copy) fn);
...
class _ACopyWithImpl<$R, $Out extends A> extends ClassCopyWithBase<$R, A, $Out>
  ...
  _ACopyWithImpl(super.value, super.then, super.then2, {super.batch});

  @override
  late final ClassMapperBase<A> $mapper = AMapper.ensureInitialized();
  @override
  ObjectCopyWith<$R, String?, String?> get a =>
      ObjectCopyWith($value.a, $identity, (v) => call(a: v));
  @override
  BCopyWith<$R, B, B>? get b =>
  ...
  $R $batch(void Function(ACopyWith<void, A, $Out> copy) fn) {
    var batch = BatchData<$R, A, $Out>();
    var copy = _ACopyWithImpl<void, $Out>($value, $then1, (_) {}, batch: batch);
    fn(copy);
    return $then2(batch.commit(this));
  }
