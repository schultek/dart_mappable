...
class SetWrapperMapper extends ClassMapperBase<SetWrapper> {
  ...
  static SetWrapper fromMap(Map<String, dynamic> map) {
    return _guard((c) => c.fromMap<SetWrapper>(map));
  }

  static SetWrapper fromJson(String json) {
    return _guard((c) => c.fromJson<SetWrapper>(json));
  }
}

mixin SetWrapperMappable {
  String toJson() {
    return SetWrapperMapper._guard((c) => c.toJson(this as SetWrapper));
  }

  Map<String, dynamic> toMap() {
    return SetWrapperMapper._guard((c) => c.toMap(this as SetWrapper));
  }
  ...
  @override
  String toString() {
    return SetWrapperMapper._guard((c) => c.asString(this));
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (runtimeType == other.runtimeType &&
            SetWrapperMapper._guard((c) => c.isEqual(this, other)));
  }

  @override
  int get hashCode {
    return SetWrapperMapper._guard((c) => c.hash(this));
  }
}
...
class ListWrapperMapper extends ClassMapperBase<ListWrapper> {
  ...
  static ListWrapper fromMap(Map<String, dynamic> map) {
    return _guard((c) => c.fromMap<ListWrapper>(map));
  }

  static ListWrapper fromJson(String json) {
    return _guard((c) => c.fromJson<ListWrapper>(json));
  }
}

mixin ListWrapperMappable {
  String toJson() {
    return ListWrapperMapper._guard((c) => c.toJson(this as ListWrapper));
  }

  Map<String, dynamic> toMap() {
    return ListWrapperMapper._guard((c) => c.toMap(this as ListWrapper));
  }
  ...
  @override
  String toString() {
    return ListWrapperMapper._guard((c) => c.asString(this));
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (runtimeType == other.runtimeType &&
            ListWrapperMapper._guard((c) => c.isEqual(this, other)));
  }

  @override
  int get hashCode {
    return ListWrapperMapper._guard((c) => c.hash(this));
  }
}
...
class MapWrapperMapper extends ClassMapperBase<MapWrapper> {
  ...
  static MapWrapper fromMap(Map<String, dynamic> map) {
    return _guard((c) => c.fromMap<MapWrapper>(map));
  }

  static MapWrapper fromJson(String json) {
    return _guard((c) => c.fromJson<MapWrapper>(json));
  }
}

mixin MapWrapperMappable {
  String toJson() {
    return MapWrapperMapper._guard((c) => c.toJson(this as MapWrapper));
  }

  Map<String, dynamic> toMap() {
    return MapWrapperMapper._guard((c) => c.toMap(this as MapWrapper));
  }
  ...
  @override
  String toString() {
    return MapWrapperMapper._guard((c) => c.asString(this));
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (runtimeType == other.runtimeType &&
            MapWrapperMapper._guard((c) => c.isEqual(this, other)));
  }

  @override
  int get hashCode {
    return MapWrapperMapper._guard((c) => c.hash(this));
  }
}
