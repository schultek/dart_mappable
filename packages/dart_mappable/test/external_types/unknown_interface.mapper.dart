...
mixin DSOpacityDataMappable {
  String toJson() {
    return DSOpacityDataMapper.ensureInitialized().encodeJson<DSOpacityData>(
      this as DSOpacityData,
    );
  }

  Map<String, dynamic> toMap() {
    return DSOpacityDataMapper.ensureInitialized().encodeMap<DSOpacityData>(
      this as DSOpacityData,
    );
  }
  ...
  @override
  String toString() {
    return DSOpacityDataMapper.ensureInitialized().stringifyValue(
      this as DSOpacityData,
    );
  }
  ...
  bool operator ==(Object other) {
    return DSOpacityDataMapper.ensureInitialized().equalsValue(
      this as DSOpacityData,
      other,
    );
  }
...
class _DSOpacityDataCopyWithImpl<$R, $Out>
  ...
  @override
  $R call({Map<BaseToken, double>? data, double? fallback}) => $apply(
    FieldCopyWithData({
