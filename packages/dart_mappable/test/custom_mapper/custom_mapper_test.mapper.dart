...
class TestObjMapper extends ClassMapperBase<TestObj> {
  ...
  final Map<Symbol, Field<TestObj, dynamic>> fields = const {
    ...
    #unmappedProps: Field<TestObj, Map<String, dynamic>>('unmappedProps', _$unmappedProps),
  };
...
mixin TestObjMappable {
  ...
  TestObjCopyWith<TestObj, TestObj, TestObj> get copyWith => _TestObjCopyWithImpl(this as TestObj, $identity, $identity);
  @override
  String toString() {
    TestObjMapper.ensureInitialized();
...
extension TestObjValueCopy<$R, $Out extends TestObj> on ObjectCopyWith<$R, TestObj, $Out> {
  TestObjCopyWith<$R, TestObj, $Out> get asTestObj => base.as((v, t, t2) => _TestObjCopyWithImpl(v, t, t2));
}

typedef TestObjCopyWithBound = TestObj;
abstract class TestObjCopyWith<$R, $In extends TestObj, $Out extends TestObj> implements ObjectCopyWith<$R, $In, $Out> {
  TestObjCopyWith<$R2, $In, $Out2> chain<$R2, $Out2 extends TestObj>(Then<TestObj, $Out2> t, Then<$Out2, $R2> t2);
...
class _TestObjCopyWithImpl<$R, $Out extends TestObj> extends CopyWithBase<$R, TestObj, $Out> implements TestObjCopyWith<$R, TestObj, $Out> {
  _TestObjCopyWithImpl(super.value, super.then, super.then2);
  @override TestObjCopyWith<$R2, TestObj, $Out2> chain<$R2, $Out2 extends TestObj>(Then<TestObj, $Out2> t, Then<$Out2, $R2> t2) => _TestObjCopyWithImpl($value, t, t2);
  ...
  @override $R call({Object? x = $none, Map<String, dynamic>? unmappedProps}) => $then(TestObj.explicit(or(x, $value.x), unmappedProps ?? $value.unmappedProps));
}
